Feature: Edit Post
  ...
  @user1 @web
  Scenario Outline: As an administrator when I create, publish and update a post it should be visible from home page with latest changes
    ...
    And I should see text <updatedPostContent>
